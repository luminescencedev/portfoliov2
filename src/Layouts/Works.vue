...
<template>
  <div class="w-screen p-10">
    <div class="w-full h-[calc(100vh-80px)] relative flex flex-col border-[#1C1C1C]/20 border border-dashed works-hero justify-end">
      ...
      <div>
        <div class="p-6">
          <h1 class="text-4xl font-bold text-[#1C1C1C]">Works :</h1>
        </div>
